...
cl:getChannel(donation_channel_id):send("Поступил донат на сумму "..body_json["payment"]["total"]["amount"].." "..code_to_text(body_json["payment"]["total"]["currency"]).." с комментарием '"..body_json["payment"]["comment"].."'")
