...
'Вы выиграли турнир по Xash3D и получили %s %s как приз',
...
'Вам кайфарик дал денег, и вы получили %s %s',
'Эй сталкер! Не шелести особо, на %s %s',
'Крабик вам сказал Закрой ГЛАЗА, и положил вам %s %s',
'Вы помогли крабику сварить чай, и за работу он вам дал %s %s',
'Подарив хелеру комп, он вам дал %s %s в качестве благодарности',
'Попросив у керика немного денег, он вам дал %s %s'
}
...
'Brain Научил вас использовать что либо, но обучение стоило %s %s',
'Кайфарик по просил у вас печек на модераторку, вы ему дали %s %s , окозалось что модераторка не продается',
'Tyabus Съел пирожное, оказалось что оно было вашим и вы потеряли %s %s которую потратили на пирожное',
'ArinaWolf Сделала вам чай, это стоило %s %s',
'Вы сказали Брейну что он гей, все оказалось наоборот и вы потеряли %s %s',
'Вас загриферил тубус, и он забрал у вас %s %s',
'Вы сказали, что DOOM 3 говно, и Печка с Тубусом отжали у вас %s %s'
}
...
local profit = (math.sqrt(math.random(1, 500)) > 10)
